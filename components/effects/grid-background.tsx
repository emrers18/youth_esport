...
export function GridBackground({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <div className="absolute -left-24 top-0 size-72 rounded-full bg-primary/20 blur-[100px] animate-float-orb" />
      <div
        className="absolute -right-16 top-24 size-64 rounded-full bg-secondary/15 blur-[100px] animate-float-orb"
